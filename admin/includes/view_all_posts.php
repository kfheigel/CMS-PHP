    ...
    foreach($_POST['checkBoxArray'] as $postValueId){
        ...
        switch($bulk_options){
            ...
            case 'reset':
                ...
                confirm($reset_views_count_query);
            break;  
        }
    }
}
...
?>
   <form action="" method="post">
    ...
    <div class="col-xs-4">
        <input type="submit" name="submit" class="btn btn-primary btn-success" value="Apply">
    ...
    <thead>
        <tr>
            <th>Check All<br/><input id="selectAllBoxes" type="checkbox"></th>
            <th>Id</th>
            <th>User</th>
            <th>Title</th>
            <th>Category</th>
...
//            $cat_title = $row['cat_title']; 
        ...
        echo "<td><a class='btn btn-primary' href='posts.php?source=edit_post.php&p_id={$post_id}'>Edit<a/></td>";
